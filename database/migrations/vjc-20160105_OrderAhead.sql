...
## -----------------------------------------------------------------------------------------------------------------
# All below have been run on all! Local, dev, and prod!! 
## -----------------------------------------------------------------------------------------------------------------
...
# 6
CREATE INDEX `idx_scheduled_window_start` ON `Order` (scheduled_window_start);
CREATE INDEX `idx_scheduled_window_end`   ON `Order` (scheduled_window_end);


# 7
ALTER TABLE `bento`.`Order` 
ADD COLUMN `utc_scheduled_window_start` DATETIME NULL DEFAULT NULL AFTER `scheduled_window_end`,
ADD COLUMN `utc_scheduled_window_end` DATETIME NULL DEFAULT NULL AFTER `utc_scheduled_window_start`;
...
# 8
ALTER TABLE `bento`.`Order` 
CHANGE COLUMN `utc_scheduled_window_start` `utc_scheduled_window_start` TIMESTAMP NULL DEFAULT NULL ,
CHANGE COLUMN `utc_scheduled_window_end` `utc_scheduled_window_end` TIMESTAMP NULL DEFAULT NULL ;
...
## -----------------------------------------------------------------------------------------------------------------
# All have been run on all! Local, dev, and prod!! 
## -------- For All ------------------------------------------------------------------------------------------------
